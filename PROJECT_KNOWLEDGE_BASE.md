...
- `README.md`：产品入口和整体架构。
- `docs/design/整体/产品设计/01-整体产品目标与定位.md`：跨版本产品决策。
- `docs/design/整体/参考资料/01-Atoms参考产品分析.md`：Atoms 参考。

### 24.2 V1

- `docs/design/V1/产品设计/01-产品范围与交互.md`：V1 产品 Contract、用户路径和验收边界。
- `docs/design/V1/产品设计/02-管理员后台.md`：V1 只读管理员后台产品设计。
- `docs/design/V1/技术设计/Agent/01-Agent运行机制.md`：V1 角色、HITL、Context、Tool 和状态机。
- `docs/design/V1/技术设计/Agent/02-对话式AI-Coding.md`：Project 对话和 ChangeProposal 初版。
- `docs/design/V1/技术设计/工程/01-系统架构.md`：V1 组件、数据、安全、恢复和部署。
- `docs/design/V1/技术设计/工程/02-运行与部署.md`：配置与部署步骤。
- `docs/review/V1/Agent评审/2026-07-13-多角色Agent设计问题整理.md`：Contract、Memory/RAG、多 Agent、TaskGraph 和 HITL 的阶段解释。

### 24.3 V2

- `docs/design/V2/产品设计/01-产品范围与交互.md`：V2 产品范围与验收。
- `docs/design/V2/技术设计/Agent/01-Agent运行机制.md`：Leader、TaskGraph、Handoff、Tool 和收敛。
- `docs/design/V2/技术设计/工程/01-系统架构.md`：Worker、PostgreSQL Lease、Object Storage 和 Sandbox。

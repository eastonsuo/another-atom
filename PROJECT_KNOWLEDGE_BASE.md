...
- `docs/design/V1/技术设计/Agent/01-多Agent设计.md`：V1 角色、HITL、Context、Tool 和状态机。
- `docs/design/V1/技术设计/Agent/02-基于现有代码的对话式AI-Coding.md`：Project 对话和 ChangeProposal 初版。

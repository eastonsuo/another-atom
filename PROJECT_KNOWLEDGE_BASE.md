...
- `docs/design/V2/技术设计/01-[Agent]-Agent运行机制.md`：Leader、TaskGraph、Handoff、Tool 和收敛。
- `docs/design/V2/技术设计/02-[工程]-系统架构.md`：Worker、PostgreSQL Lease、Object Storage 和 Sandbox。

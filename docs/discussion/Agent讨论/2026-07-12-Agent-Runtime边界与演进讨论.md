...
- 讨论日期：2026-07-12
- 版本范围：整体
- 产品总纲：[整体产品目标与定位](../../design/整体/产品设计/整体产品目标与定位.md)
- 正式设计：[V1 Agent 设计](../../design/V1/Agent设计/Agent设计.md) · [V1 架构设计](../../design/V1/工程设计/架构设计.md) · [V2 Agent 设计](../../design/V2/Agent设计/Agent设计.md)

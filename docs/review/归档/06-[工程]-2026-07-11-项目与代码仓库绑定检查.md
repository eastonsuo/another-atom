...
> **2026-07-13 归档 Update：** Project 与平台本地 Git 仓库的一对一关系、Version→commit、Restore 和代码查看已经进入 [V1 核心产品需求与交互](../../design/V1/产品设计/01-核心产品需求与交互.md)与 [V1 系统架构](../../design/V1/技术设计/工程/01-系统架构.md)。用户自有 GitHub/GitLab remote 已明确不属于 V1，因此不作为本 Review 的未关闭问题。

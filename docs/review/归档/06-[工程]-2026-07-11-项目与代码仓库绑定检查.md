...
> 类型：检查｜状态：部分已修复，详见下方 Update｜日期：2026-07-11｜范围：Project、Git 仓库、Version 与交付归属

> **2026-07-13 归档 Update：** Project 与平台本地 Git 仓库的一对一关系、Version→commit、Restore 和代码查看已经进入 [V1 核心产品需求与交互](../../design/V1/产品设计/01-核心产品需求与交互.md)与 [V1 系统架构](../../design/V1/技术设计/03-[工程]-系统架构.md)。用户自有 GitHub/GitLab remote 已明确不属于 V1，因此不作为本 Review 的未关闭问题。

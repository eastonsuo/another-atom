...
> **2026-07-13 归档 Update：** 表中高优先级问题已经修复并由后续测试覆盖；版本来源、配额、恢复和审计规则已进入 [V1 多 Agent 设计](../../design/V1/技术设计/01-[Agent]-多Agent设计.md)与 [V1 系统架构](../../design/V1/技术设计/03-[工程]-系统架构.md)。尚未完成的仓库内开发项由 [V1 剩余开发待办](../待办/13-[综合]-2026-07-13-V1剩余开发待办.md)接管。

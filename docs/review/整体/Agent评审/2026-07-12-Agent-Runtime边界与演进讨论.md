...
- 讨论日期：2026-07-12
- 版本范围：整体
- 产品总纲：[整体产品目标与定位](../../../design/整体/产品设计/01-整体产品目标与定位.md)
- 正式设计：[V1 Agent 运行机制](../../../design/V1/技术设计/Agent/01-Agent运行机制.md) · [V1 系统架构](../../../design/V1/技术设计/工程/01-系统架构.md) · [V2 Agent 运行机制](../../../design/V2/技术设计/Agent/01-Agent运行机制.md)
- 实现证据：[V1 关键设计与实现 Review](../../V1/综合评审/2026-07-12-关键设计与实现检查.md)

...
- 更新日期：2026-07-11
- 产品文档：[Another Atom V2 产品需求文档](../产品设计/产品需求.md)
- Agent 设计：[Another Atom V2 Agent 设计](../Agent设计/Agent设计.md)
- V1 架构基线：[Another Atom V1 架构设计](../../V1/工程设计/架构设计.md)
...
Agent Provider、Handoff、Rework 和收敛语义以 [V2 Agent 设计](../Agent设计/Agent设计.md)为准；工程 Runtime 负责：

...
- V2 工程设计：[V2 系统架构](../工程/01-系统架构.md)
- V1 工程基线：[V1 系统架构](../../../V1/技术设计/工程/01-系统架构.md)
- V1 Agent 基线：[V1 Agent 运行机制](../../../V1/技术设计/Agent/01-Agent运行机制.md)
- V1 产品范围：[V1 产品范围与交互](../../../V1/产品设计/01-产品范围与交互.md)
- 参考分析：[Atoms 参考产品分析](../../../整体/参考资料/01-Atoms参考产品分析.md)
...
- 预算预占、结算、释放和部分失败补偿由 Runtime 执行，具体事务语义以 [V2 系统架构：并行配额与部分失败](../工程/01-系统架构.md#5-并行配额与部分失败)为准。

...
- Agent 设计：[Another Atom V2 Agent 运行机制](../Agent/01-Agent运行机制.md)
- V1 工程基线：[Another Atom V1 系统架构](../../../V1/技术设计/工程/01-系统架构.md)
...
Agent Provider、Handoff、Rework 和收敛语义以 [V2 Agent 运行机制](../Agent/01-Agent运行机制.md)为准；工程 Runtime 负责：

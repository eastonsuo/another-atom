...
公开材料显示 Atoms 是围绕“从意图到在线产品”的 Agent 工作台，覆盖输入、编排、预览编辑、数据与服务、校验修复、版本发布以及用量管理。本文按正式帮助文章、Changelog 和冲突/未知三种证据强度记录能力；未公开的内部机制不能判断，本分析也不构成 Another Atom 的正式 Design Contract。

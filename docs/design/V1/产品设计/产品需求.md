...
- 前置文档：[Atoms 参考产品功能分析](../../整体/参考资料/Atoms参考产品分析.md)
- 技术文档：[Another Atom V1 架构设计](../工程设计/架构设计.md)
...
上述决策已经进入设计基线：架构、数据模型、发布方案、目录结构、测试和部署流程见 [Another Atom V1 架构设计](../工程设计/架构设计.md)；执行范式、角色 Contract、Human-in-the-loop、Context、Tool、Sandbox、验收和有限修复见 [Another Atom V1 Agent 设计](../Agent设计/Agent设计.md)。

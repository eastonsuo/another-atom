...
- 展示生成状态和简介，并提供打开完整 Markdown 的明确入口；
- 简介支持直接修改，也支持在保留当前内容的基础上重新生成；
...
- 展示可编辑的简介；
- 明确提示完整文档位于 `docs/product-spec.md`，并提供按钮在右侧项目文件中直接打开；用户也可通过通用文档功能直接编辑；
- Markdown 编辑区提供撤销和重做，保存后再参与当前 ProductSpec generation；

...
- 参考资料：[Atoms 参考产品分析](../../整体/参考资料/01-Atoms参考产品分析.md)
- 技术设计：[Another Atom V1 系统架构](../技术设计/工程/01-系统架构.md)
...
上述决策已经进入设计基线：架构、数据模型、发布方案、目录结构、测试和部署流程见 [Another Atom V1 系统架构](../技术设计/工程/01-系统架构.md)；执行范式、角色 Contract、Human-in-the-loop、Context、Tool、Sandbox、验收和有限修复见 [Another Atom V1 Agent 运行机制](../技术设计/Agent/01-Agent运行机制.md)。

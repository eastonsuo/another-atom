...
- **Agent 基线：** [V1 多 Agent 设计](./01-多Agent设计.md)
- **工程基线：** [V1 系统架构](../工程/01-系统架构.md)
...
本功能不改变 V1 的固定团队，只把首次生成的全量 Contract 改成基于基线的增量 Contract。当前代码中的具体角色名称继续以 [V1 多 Agent 设计](./01-多Agent设计.md) 为准，本篇只定义修改语义：

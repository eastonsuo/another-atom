...
3. **[修改 Context 与 Patch]** 从完整有效 Contract 与基线 Git 源码生成 ModificationContextPackage，实现 `MAX_SOURCE_CHARS`、固定文件顺序装箱和包含/省略清单，接入 `create_source_patch`，并实现隔离候选工作区 apply。
